...
import 'package:cinemapedia/presentation/provider/storage/is_favorite_movie_provider.dart';
...
class _ActosByMovie extends ConsumerWidget {
  ...
  final String movieId;
  const _ActosByMovie({super.key, required this.movieId});
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(actor.name ?? 'no especifícado', maxLines: 2,),
